...
class WeeklyForecastList extends StatelessWidget {
    ...
    return SliverList(
      delegate: SliverChildBuilderDelegate(
          ...
          return Card(
            child: Row(
              children: <Widget>[
                weatherImage(dailyForecast, currentDate, textTheme),
                Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(20.0),
                    child: buildColumn(dailyForecast, currentDate, textTheme),
                  ),
                ),
                buildPadding(dailyForecast, textTheme),
              ],
            ),
          );
        },
  ...
  Column buildColumn(DailyForecast dailyForecast, DateTime currentDate, TextTheme textTheme) {
    return Column(
  ...
  Padding buildPadding(DailyForecast dailyForecast, TextTheme textTheme) {
    return Padding(
  ...
  SizedBox weatherImage(DailyForecast dailyForecast, DateTime currentDate, TextTheme textTheme) {
    return SizedBox(
                height: 200.0,
                width: 200.0,
                child: Stack(
